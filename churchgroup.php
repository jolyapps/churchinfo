...
$address_grp_p = addslashes($_POST[adress_grp_p]);
 ...
 $skypeid_grp_p = addslashes($_POST[skypeid_grp_p]);
  $stat_grp_p = addslashes($_POST[state_grp_p]);
  $reg_reg_p = addslashes($_POST[reg_reg_ch]);
   $grp_grp_p = addslashes($_POST[grp_grp_ch]);
...
&nbsp;<br />
	...
	<marquee scrollammount ="2" style="height: 27px; width: 1033px; azimuth:center; position:absolute; left: 9px; top: 3px;" scrollamount="2" class="auto-style29" >Please scroll sideways to fill in all the data for tour Church Location<?php echo "$name"?></marquee></div>
...
<div class="carpet" style="width: 1188px; height: 523px; left: 10px; top: 193px;">
	...
	<form action="churchgroup.php" style="height: 12px" method="post" enctype="multipart/form-data">
...
&nbsp;<br />
		...
		<br />
		<br />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DISTRICT CHURCH INFORMATION&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DISTRICT&nbsp; PASTOR'S INFORMATION<br />
	
	
	
		<input type="submit" class="input2" style="left: 431px; top: 422px" value="Register" name="reg" /><br />
		<br />
		...
		<input class="auto-style25" style="height: 27px; width: 273px; top: 321px; right: 560px; left: 153px;" name="dis_skid" id="dis_skid"/><input class="auto-style25" style="height: 27px; width: 273px; top: 285px; right: 563px; left: 150px;" name="dis_phn" id="dis_phn"/><input class="auto-style25" style="height: 27px; width: 273px; top: 248px; right: 560px; left: 153px;" name="dis_email" id="dis_email"/><input class="auto-style25" style="height: 27px; width: 273px; top: 211px; right: 560px; " name="dis_address" id="dis_address"/><input class="auto-style25" style="height: 27px; width: 273px; top: 174px; right: 559px; " name="dis_pro" id="dis_pro"/>
		<br />
	
	
	

		<input class="auto-style25" style="height: 27px; width: 273px; top: 173px; right: 96px; " name="dis_p_name" id="dis_p_name"/>
	  <input class="auto-style25" style="height: 27px; width: 273px; top: 320px; right: 99px; left: 614px;" name="dis_skype_p" id="dis_skype_p"/>
	  <input class="auto-style25" style="height: 27px; width: 273px; top: 281px; right: 98px; " name="dis_phn_p" id="dis_phn_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 245px; right: 99px; " name="dis_em_p" id="dis_em_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 212px; right: 98px; " name="dis_add_p" id="dis_add_p"/>
  <div class="auto-style20"  style="width: 142px; position:absolute; left: 2px; top: 289px; right: 838px;" >
			Church Picture</div>
  ...
  <div class="auto-style20"  style="width: 142px; position:absolute; left: 3px; top: 243px; right: 841px;" >
	...
	<input type="hidden" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="hq_grp_p" value="<?php echo $name_grp_p  ; ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="adress_grp_p" value="<?php echo $address_grp_p ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 2px; top: 176px; height: 23px; width: 145px;" size="1" class="auto-style38" name="phn_grp_p" value="<?php echo $phn_grp_p  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="email_grp_p" value="<?php echo $email_grp_p  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="skypeid_grp_p" value="<?php echo $skypeid_grp_p ?>"/>
		...
		<br />
		<br />
		<input  type="file"  class="input2" style="height: 29px; width: 192px; left: 159px; top: 372px; right: 631px;" name="pics" /></form>
