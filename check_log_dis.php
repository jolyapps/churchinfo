...
mysql_select_db("locprofile", $con);
 $sql = " SELECT * FROM districtpastorpersonalinfo WHERE email = '$email'  " ;
...
$counter = mysql_num_rows($result);
 ...
 $sql = "INSERT INTO districtpastorpersonalinfo(name,tit,address,phn,email,skid,country,stat,picture,region,grp,district,address_loc,pob_loc,phn_loc,email_loc,skypeid_loc) VALUES ('$name','$title','$address','$phn','$email','$skypeid','$country','$stat','$wolex','$reg','$grp','$dis','$add','$pob','$phone','$email_ch','$skype')";
...
header('location:district.php?log_db=false');
...
header('location:district.php?log_tr=false');
...
<div class="carpet" style="width: 810px; height: 594px; left: 6px; top: 145px;">
	...
	<form action="churchdistrict.php" method="post" enctype="multipart/form-data"  style="position:absolute; left: 14px; top: 85px; width: 454px; height: 38px;">
