...
//The Churches information
$name_nat  = addslashes($_POST[hq_nat]);
$address_nat  = addslashes($_POST[adress_nat]);
$phn_nat  = addslashes($_POST[phn_nat]);
$email_nat  = addslashes($_POST[email_nat]);
$skypeid_nat =addslashes($_POST[skypeid_nat]);
...
mysql_select_db("locprofile", $con);
 $sql = " SELECT * FROM nationaloverseer WHERE email = '$email'  " ;
...
$counter = mysql_num_rows($result);
 ...
 //$sql = "INSERT INTO nationaloverseer (name,tit,address,phn,email,skid,country,stat,picture,Reggrp,district,locatn) VALUES
 //('$name','$title','$add','$phone','$email','$skype','$country' ,'$stat','$wolex','$regi','$dist','$locatn') ";
...
<div class="carpet" style="width: 810px; height: 594px; left: 6px; top: 145px;">
	...
	<form action="countrynational.php" method="post" enctype="multipart/form-data"  style="position:absolute; left: 14px; top: 85px; width: 454px; height: 38px;">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 				
		...
		&nbsp;Click on proceed to continue your Registration</form>
<form method="post" action="churchreg.php">
		<input type="text" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="tit_pass" value="<?php echo $title ?>">
		<input type="text" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="email_pass" value="<?php echo $email ?>"/>
		<input type="text" style="border: 0px dotted #333333; left: 2px; top: 176px; height: 23px; width: 145px;" size="1" class="auto-style38" name="name_pass" value="<?php echo $name  ?>"/>
		<input type="text" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="count_pass" value="<?php echo $country  ?>"/>
		
		<!--THe HQ INFORMATION-->
		
		<input type="hidden" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="hq_nat_p" value="<?php echo $title ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="adress_nat_p" value="<?php echo $email ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 2px; top: 176px; height: 23px; width: 145px;" size="1" class="auto-style38" name="phn_nat_p" value="<?php echo $name  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="email_nat_p" value="<?php echo $country  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="skypeid_nat_p" value="<?php echo $country  ?>"/>
		...
		<input type="submit" class="input2" style="left: 202px; top: 246px; width: 244px;" value="Proceed to Fill the Church Locations" name="proc" /></div>
