...
$address_dis_p = addslashes($_POST[adress_dis_p]);
 ...
 $skypeid_dis_p = addslashes($_POST[skypeid_dis_p]);
  $dis = addslashes($_POST[district]);
  $stat_dis_p = addslashes($_POST[state_dis_p]);
  $reg_reg_p = addslashes($_POST[reg_reg_p]);
   $grp_grp_p = addslashes($_POST[grp_grp_p]);
...
<div class="marq" style="height: 32px; width: 1044px; left: 177px; top: 154px; bottom: -156px;">
	<marquee scrollammount ="2" style="height: 27px; width: 1033px; azimuth:center; position:absolute; left: 9px; top: 3px;" scrollamount="2" class="auto-style29" >Please scroll sideways to fill in all the data for your Church Location<?php echo "$name"?></marquee></div>
...
<div class="carpet" style="width: 1188px; height: 523px; left: 10px; top: 193px;">
	...
	<form action="localgoververnmentreg.php" style="height: 12px" method="post" enctype="multipart/form-data">
...
&nbsp;<br />
		...
		YOUR LOCATION CHURCH 
		INFORMATION&nbsp;HERE &nbsp;&nbsp;&nbsp;&nbsp;</span><span class="auto-style32"><span class="auto-style33">&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
		<br />
		<br />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LOCATION CHURCH INFORMATION&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		&nbsp;&nbsp;&nbsp;LOCATION&nbsp; PASTOR'S INFORMATION<br />
	
	
	
		<input type="submit" class="input2" style="left: 429px; top: 423px" value="Register" name="reg" /><br />
		<br />
		...
		<div class="auto-style20"  style="width: 142px; position:absolute; left: 3px; top: 93px; right: 841px;" >LOCATION</div>
	
	
	

		<input class="auto-style25" style="height: 27px; width: 273px; top: 321px; right: 560px; left: 153px;" name="loc_skid" id="loc_skid"/><input class="auto-style25" style="height: 27px; width: 273px; top: 285px; right: 563px; left: 150px;" name="loc_phn" id="loc_phn"/><input class="auto-style25" style="height: 27px; width: 273px; top: 248px; right: 560px; left: 153px;" name="loc_email" id="loc_email"/><input class="auto-style25" style="height: 27px; width: 273px; top: 211px; right: 560px; " name="loc_address" id="loc_address"/><input class="auto-style25" style="height: 27px; width: 273px; top: 174px; right: 559px; " name="location" id="location"/>
		<br />
	
	
	

		<input class="auto-style25" style="height: 27px; width: 273px; top: 173px; right: 96px; " name="loc_p_name" id="loc_p_name"/>
	  <input class="auto-style25" style="height: 27px; width: 273px; top: 320px; right: 99px; left: 614px;" name="loc_skype_p" id="loc_skype_p"/>
	  <input class="auto-style25" style="height: 27px; width: 273px; top: 281px; right: 98px; " name="loc_phn_p" id="loc_phn_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 245px; right: 99px; " name="loc_em_p" id="loc_em_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 212px; right: 98px; " name="loc_add_p" id="loc_add_p"/>
  <div class="auto-style20"  style="width: 142px; position:absolute; left: 3px; top: 294px; right: 837px;" >
			Church Picture</div>
  ...
  <div class="auto-style20"  style="width: 142px; position:absolute; left: 3px; top: 243px; right: 841px;" >
	...
	<input type="hidden" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="hq_dis_p" value="<?php echo $name_dis_p  ; ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="adress_dis_p" value="<?php echo $address_dis_p ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 2px; top: 176px; height: 23px; width: 145px;" size="1" class="auto-style38" name="phn_dis_p" value="<?php echo $phn_dis_p  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="email_dis_p" value="<?php echo $email_dis_p  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="skypeid_dis_p" value="<?php echo $skypeid_dis_p ?>"/>
        ...
        <input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="grp_grp_p" value="<?php echo $grp_grp_p ?>"/>
        
       <input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="district" value="<?php echo $dis ?>"/>
		...
		<br />
		<br />
		<input  type="file"  class="input2" style="height: 29px; width: 192px; left: 157px; top: 378px; right: 633px;" name="pics" /></form>
