...
$address_stat_p = addslashes($_POST[adress_stat_p]);
 ...
 $skypeid_stat_p = addslashes($_POST[skypeid_stat_p]);
  $stat_stat_p = addslashes($_POST[stat]);
...
.auto-style251 {	background-color: white;
	width: 175px;
	border: 1px solid #999;
	height: 25px;
	position: absolute;
...
.auto-style252 {	background-color: white;
	width: 175px;
	border: 1px solid #999;
	height: 25px;
	position: absolute;
...
<div class="carpet" style="width: 1188px; height: 523px; left: 10px; top: 193px;">
	...
	<form action="churchregstat.php" style="height: 12px" method="post" enctype="multipart/form-data" >
...
&nbsp;<br />
		...
		<br />
		<br />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;REGIONS CHURCH INFORMATION&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;REGION&nbsp; PASTOR'S INFORMATION<br />
	
	
	
		<input type="submit" class="input2" style="left: 436px; top: 452px" value="Register" name="reg" /><br />
		<br />
		...
		<input class="auto-style252" style="height: 27px; width: 273px; top: 321px; right: 560px; left: 153px;" name="re_skid" id="re_skid"/>
		<input class="auto-style251" style="height: 27px; width: 273px; top: 285px; right: 563px; left: 150px;" name="re_phn" id="re_phn"/>
		<input class="auto-style25" style="height: 27px; width: 273px; top: 248px; right: 560px; left: 153px;" name="re_email" id="re_email"/><input class="auto-style25" style="height: 27px; width: 273px; top: 211px; right: 560px; " name="re_address" id="re_address"/><input class="auto-style25" style="height: 27px; width: 273px; top: 174px; right: 559px; " name="re_pro" id="re_pro"/>
		<br />
	
	
	

		<input class="auto-style25" style="height: 27px; width: 273px; top: 173px; right: 96px; " name="re_p_name" id="re_p_name"/>
	  <input class="auto-style25" style="height: 27px; width: 273px; top: 320px; right: 99px; left: 614px;" name="re_skype_p" id="re_skype_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 281px; right: 98px; " name="re_phn_p" id="re_phn_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 245px; right: 99px; " name="re_em_p" id="re_em_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 212px; right: 98px; " name="re_add_p" id="re_add_p"/>
    <div class="auto-style20"  style="width: 142px; position:absolute; left: 7px; top: 295px; height: 19px;" >
			Church Image</div>
	...
	<input type="hidden" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="hq_stat_p" value="<?php echo $name_stat_p  ; ?>"/>
		...
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="stat_stat_p" value="<?php echo $stat_stat_p ?>"/>
		...
		<br />
		<br />
		<input  type="file"  class="input2" style="height: 29px; width: 192px; left: 160px; top: 383px; right: 630px;" name="pics" /></form>
