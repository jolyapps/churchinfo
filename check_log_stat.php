...
mysql_select_db("locprofile", $con);
 $sql = " SELECT * FROM statepastorpersonalinfo WHERE email = '$email_stat_p'  " ;
...
header('location:stateindex.php?log_db=false');
 ...
 if(!mysql_query($sql,$con))
  ...
  $show_form=false;
    ...
    header('location:stateindex.php?log_tr=false');
