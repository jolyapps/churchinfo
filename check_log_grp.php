...
$name_grp_p  = addslashes($_POST[name_p]);
$address_grp_p  = addslashes($_POST[address_p]);
$phn_grp_p  = addslashes($_POST[phn_p]);
$email_grp_p  = addslashes($_POST[email_p]);
$skypeid_grp_p =addslashes($_POST[skid_p]);
$title_grp_p = addslashes($_POST[tit_p]);
...
$stat = addslashes($_POST[state_ch]);
...
mysql_select_db("locprofile", $con);
 $sql = " SELECT * FROM grouppastorpersonalinfo WHERE email = '$email'  " ;
...
$counter = mysql_num_rows($result);
 ...
 $sql = "INSERT INTO grouppastorpersonalinfo(name,tit,address,phn,email,skid,country,stat,picture,region,hq_grp,address_grp,pob_grp,phn_grp,email_grp,skypeid_grp) VALUES
  ('$name','$title_reg_p ','$add','$phone','$email','$skype','$country','$stat','$wolex','$name_grp_p','$grp','$address_grp_p','$pob_grp_p','$phn_grp_p','$email_grp_p','$skypeid_grp_p') ";
...
$counter = 1 ;
header('location:groupindex.php?log_db=false');
...
header('location:groupindex.php?log_tr=false');
...
<title>DCLM Church Location | Groups</title>
...
&nbsp;<br />
	...
	<marquee scrollammount ="2" style="height: 27px; position : absolute; left: 5px; top: 6px; width: 653px;" scrollamount="2"><font color="white">You are welcome  <?php echo $name_grp_p ; ?>, Click on proceed to continue your registration.&nbsp; </font></marquee></div>
...
<div class="carpet" style="width: 810px; height: 594px; left: 6px; top: 145px;">
	...
	<form action="churchgroup.php" method="post" enctype="multipart/form-data"  style="position:absolute; left: 14px; top: 85px; width: 454px; height: 38px;">
...
echo "<script> document.write('<font size =3 color = red><br><b>Welcome $name_grp_p !</b><hr><br><br></font>');
</script>";
...
<input type="hidden" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="hq_grp_p" value="<?php echo $name_grp_p  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="adress_grp_p" value="<?php echo $address_grp_p  ?>"/>
				<input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="reg_reg_ch" value="<?php echo $reg ?>"/>
                <input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="grp_grp_ch" value="<?php echo $grp ?>"/>
