...
&nbsp;<br />
	...
	<marquee scrollammount ="2" style="height: 27px; width: 1033px; azimuth:center; position:absolute; left: 9px; top: 3px;" scrollamount="2" class="auto-style29" >Please scroll sideways to fill in all the data for your Church location(s)<?php echo "$name"?></marquee></div>
...
<div class="carpet" style="width: 1188px; height: 523px; left: 10px; top: 193px;">
	...
	<form action="churchregnat.php" style="height: 12px" method="post" enctype="multipart/form-data">
...
&nbsp;<br />
		...
		<br />
		<br />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;STATE CHURCH INFORMATION&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PASTOR'S INFORMATION<br />
	
	
	
		<input type="submit" class="input2" style="left: 429px; top: 433px" value="Register" name="reg" /><br />
		<br />
		...
		<div class="auto-style34"  style="width: 738px; position:absolute; left: 121px; top: 0px; right: 123px;" >
<?php
$chk = $_REQUEST[log_db];
if($chk != false) {

echo "<font size =3 color = red><br><br>Add More Church Location</font>";
...
?>
		...
		<input  type="file"  class="input2" style="height: 29px; width: 192px; left: 162px; top: 398px; right: 628px;" name="pics"/><input class="auto-style25" style="height: 27px; width: 273px; top: 321px; right: 560px; left: 153px;" name="skid_st"/><input class="auto-style25" style="height: 27px; width: 273px; top: 285px; right: 563px; left: 150px;" name="st_phn"/><input class="auto-style25" style="height: 27px; width: 273px; top: 248px; right: 560px; left: 153px;" name="st_email"/><input class="auto-style25" style="height: 27px; width: 273px; top: 211px; right: 560px; " name="st_address"/><input class="auto-style25" style="height: 27px; width: 273px; top: 174px; right: 559px; " name="st_pro"/><br />
	
	
	

		<input class="auto-style25" style="height: 27px; width: 273px; top: 173px; right: 96px; " name="st_p_name"/><input class="auto-style25" style="height: 27px; width: 273px; top: 320px; right: 99px; " name="st_skype_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 281px; right: 98px; " name="st_phn_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 245px; right: 99px; " name="st_em_p"/><input class="auto-style25" style="height: 27px; width: 273px; top: 212px; right: 98px; " name="st_add_p"/><div class="auto-style20"  style="width: 142px; position:absolute; left: 4px; top: 313px; right: 836px;" >
			Church Picture</div>
	...
	<input type="hidden" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="hq_nat_p" value="<?php echo $name_nat  ; ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="adress_nat_p" value="<?php echo $address_nat ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 2px; top: 176px; height: 23px; width: 145px;" size="1" class="auto-style38" name="phn_nat_p" value="<?php echo $phn_nat  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="email_nat_p" value="<?php echo $email_nat  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="skypeid_nat_p" value="<?php echo $skypeid_nat ?>"/>
