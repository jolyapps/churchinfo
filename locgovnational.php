...
// $sql = "DELETE FROM countrynatover WHERE address = ''  " ;
  ...
  $sql = "INSERT INTO    localgovfilllocations(name_district_pastor,adress_district_pastor,phn_district_pastor,email_district_pastor,skypeid_district_pastor ,tittle_filler,country,stat,region,group1,district,location_ch,loc_em_ch,loc_phn_ch,loc_pob_ch,loc_skype_ch,loc_name_p,loc_add_p,loc_em_p,loc_phn_p,loc_skype_p,churchpics) VALUES
...
//header('location:http://wolex2care.com');
    ...
    // if(isset($_POST['Submit'])){
      ...
      header('location:http://dclm.org');
        echo "<center><p><font color = 'red'>You must at least fill one local government location<br></font></p></center>\n";
