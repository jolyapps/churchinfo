...
$validator = new FormValidator();
   ...
   //$validator->addValidation("Email","email","the light of the world");
    $validator->addValidation("skid","req","the light of the world");
...
$phn  = addslashes($_POST[phn]);
$email  = addslashes($_POST[email]);
$skypeid =addslashes($_POST[skid]);
...
$stat = addslashes($_POST[state]);
$file   = addslashes($_POST[pics]); 
$name_ch = addslashes($_POST[district]);
$add = addslashes($_POST[address_ch]);
$phone = addslashes($_POST[phn_ch]);
$email_ch=addslashes($_POST[email_ch]);
$group=addslashes($_POST[grp]);
...
mysql_select_db("locprofile", $con);
 $sql = " SELECT * FROM localgovernmentinfo WHERE email = '$email'  " ;
...
$counter = mysql_num_rows($result);
 ...
 $sql = "INSERT INTO localgovernmentinfo(name,tit,address,phn,email,skid,country,stat,picture,region,grp,district,address_loc,pob_loc,phn_loc,email_loc,skypeid_loc) VALUES ('$name','$title','$address','$phn','$email','$skypeid','$country','$stat','$wolex','$reg','$grp','$dis','$add','$pob','$phone','$email_ch','$skype')";
...
header('location:localgovernment.php?log_db=false');
 ...
 if(!mysql_query($sql,$con))
  ...
  $show_form=false;
    ...
    //  if(isset($_POST['Submit'])){
     ...
     header('location:localgovernment.php?log_tr=false');
...
<div class="carpet" style="width: 810px; height: 594px; left: 6px; top: 145px;">
	...
	<form action="localgoververnmentreg.php" method="post" enctype="multipart/form-data"  style="position:absolute; left: 14px; top: 85px; width: 454px; height: 38px;">
...
<input type="hidden" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="hq_dis_p" value="<?php echo $name  ?>"/>

<input type="hidden" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="grp_grp_p" value="<?php echo $group ?>"/>

<input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="district" value="<?php echo $dis ?>"/>

		<input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="adress_dis_p" value="<?php echo $address  ?>"/>
        ...
        <input type="hidden" style="border: 0px dotted #333333; left: 2px; top: 176px; height: 23px; width: 145px;" size="1" class="auto-style38" name="phn_dis_p" value="<?php echo $phn ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="email_dis_p" value="<?php echo $email ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="skypeid_dis_p" value="<?php echo $skypeid ?>"/>
