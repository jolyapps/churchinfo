...
$name_nat  = addslashes($_POST[name]);
...
$counter = mysql_num_rows($result);
 ...
 $sql = "INSERT INTO nationaloverseer (name,tit,address,phn,email,skid,country,stat,picture,hq_nat,adress_nat,pob,phn_nat,email_nat,skypeid_nat) VALUES
  ('$name','$title','$add','$phone','$email','$skype','$country','$stat','$wolex','$name_nat','$address_nat','$pob','$phn_nat','$email_nat','$skypeid_nat') ";
...
$counter = 1;
header('location:nationalindex.php?log_db=false');
 ...
 if(!mysql_query($sql,$con))
  ...
  $show_form=false;
    ...
    //  if(isset($_POST['Submit'])){
      ...
      header('location:nationalindex.php?log_tr=false');
...
<div class="carpet" style="width: 810px; height: 594px; left: 6px; top: 145px;">
	...
	<form action="churchregnat.php" method="post" enctype="multipart/form-data"  style="position:absolute; left: 14px; top: 85px; width: 454px; height: 38px;">
...
<input type="hidden" style="border: 1px dotted #333333; left: 311px; top: 177px; height: 21px; width: 145px;" size="1" class="auto-style37" name="hq_nat_p" value="<?php echo $name_nat  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 483px; top: 179px; height: 21px; width: 164px;" size="1" class="auto-style37" name="adress_nat_p" value="<?php echo $add  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 2px; top: 176px; height: 23px; width: 145px;" size="1" class="auto-style38" name="phn_nat_p" value="<?php echo $phone ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="email_nat_p" value="<?php echo $email  ?>"/>
		<input type="hidden" style="border: 0px dotted #333333; left: 154px; top: 176px; height: 24px; width: 145px;" size="1" class="auto-style38" name="skypeid_nat_p" value="<?php echo $skype ?>"/>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 				
		...
		<input type="submit" class="input2" style="left: 142px; top: 75px; width: 250px;" value="Proceed to Fill the Church Locations" name="proc" /></div>
